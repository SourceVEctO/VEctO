...
if text == "ترتيب الاوامر" and Constructor(msg) then
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"ا")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"م")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"اد")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"مد")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"من")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"اس")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"تعط")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"تفع")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"تك")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"رد")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
 database:sadd(bot_id.."VEctOList:Cmd:Group:New"..msg.chat_id_,"حذ")
 database:set(bot_id.."VEctOSet:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
