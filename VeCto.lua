...
if hash or Bot(msg) or DevVEctO(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevVEctO(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
var = true
elseif DevVEctO(user_id) == true then
var = true
...
local VEctO_Msg = database:sismember(bot_id.."VEctO:List:Filter:text"..msg.chat_id_,text) 
if VEctO_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."VEctO:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."VEctO:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."VEctO:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
database:set(bot_id.."VEctO:Lock:Xn"..msg.chat_id_,"del")  
...
database:del(bot_id.."VEctO:Lock:Xn"..msg.chat_id_)  
...
database:set(bot_id.."VEctO:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."VEctO:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."VEctO:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."VEctO:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."VEctO:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."VEctO:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."VEctO:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."VEctO:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."VEctO:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:sadd(bot_id.."VEctO:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."VEctO:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."VEctO:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."VEctO:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."VEctO:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_," ゠⁞ تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."VEctO:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_," ゠⁞ تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."VEctO:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_," ゠⁞ تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."VEctO:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."VEctO:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
database:sadd(bot_id.."VEctO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."VEctO:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_VEctO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_VEctO then 
names_VEctO = database:smembers(bot_id.."VEctO:blocname"..msg.chat_id_) or ""
if names_VEctO and names_VEctO[1] then 
for i=1,#names_VEctO do 
if name_VEctO:match("(.*)("..names_VEctO[i]..")(.*)") then 
...
database:set(bot_id.."VEctO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."VEctO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."VEctO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."VEctO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."VEctO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_VEctOa_new(VEctO1,VEctO2)
if VEctO2 and VEctO2.first_name_ then 
if VEctO2.first_name_:match("(.*)"..database:get(bot_id.."VEctO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."VEctO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local VEctO_nnn = database:get(bot_id.."VEctO:nump"..msg.chat_id_) or 5
local VEctO_nnn2 = database:get(bot_id.."VEctO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(VEctO_nnn2) == tonumber(VEctO_nnn) or tonumber(VEctO_nnn2) > tonumber(VEctO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."VEctO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "゠⁞ عزيزي >>["..VEctO2.username_.."](https://t.me/"..(VEctO2.username_ or "IIIS1")..")\n゠⁞ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."VEctO:teh"..msg.chat_id_).."} بجانب اسمك\n゠⁞ عدد المحاولات المتبقيه {"..(tonumber(VEctO_nnn) - tonumber(VEctO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_VEctOa_new)
end
end
...
local VEctOChengName = database:get(bot_id.."VEctO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if VEctOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..VEctOChengName..']')
database:del(bot_id.."VEctO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if VEctOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."VEctO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local VEctOChengUserName = database:get(bot_id.."VEctO:Cheng:UserName"..data.id_)
if not data.username_ then 
if VEctOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..VEctOChengUserName..']')
database:del(bot_id.."VEctO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if VEctOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."VEctO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local VEctOChengPhoto = database:get(bot_id.."VEctO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if VEctOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."VEctO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if VEctOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."VEctO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if DevVEctO(msg) then
local Get_Files, res = https.request("https://rew.github.com/TEAMVEctO/files_VEctO/master/getfile.json")
if res == 200 then
...
Sf = database:get(bot_id.."VEctO:Filter:msg")
local list = database:smembers(bot_id.."VEctO:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."VEctO:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."VEctO:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."VEctO:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevVEctO(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."VEctO:Filter"..msg.sender_user_id_) then
...
------------------------------------------------------------------------
if text then
local VEctO_Msg = database:sismember(bot_id.."VEctO:List:Filter:text"..result.chat_id_,text) 
if VEctO_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."VEctO:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."VEctO:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."VEctO:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
